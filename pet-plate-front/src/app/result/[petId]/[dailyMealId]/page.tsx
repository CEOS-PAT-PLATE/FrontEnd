...
const getSelectedDate = () => {
  ...
  if (!selectedDate) {
    console.error('No selectedDate found in localStorage');
    return getTodayDate();
  }
  return selectedDate;
};
...
export default function Page({ params }: ResultProps) {
  ...
  const date = getSelectedDate(); // Get the selected date
  const { year, month, day } = getTodayDateDisplay(); // You might want to update this to reflect the selected date as well
