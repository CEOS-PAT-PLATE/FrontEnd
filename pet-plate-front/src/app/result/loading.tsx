...
export default function Page() {
  return (
    <Wrapper>
        <TextWrapper>
          <DateTitle><GreenText>김백순</GreenText>의 영양소를 분석하고 있어요.</DateTitle>
      ...
      < DescriptionWrapper>
      <Description>펫플레이트는 질병 치료 목적의 서비스가 아닌,
</Description>
<Description>
반려견 건강 관리를 위한 보조적인 수단입니다.
</Description>
<Description>
질병이 있는 경우 반드시 수의사와 상담하시기 바랍니다.</Description>
</ DescriptionWrapper>
    </Wrapper>
  );
}
