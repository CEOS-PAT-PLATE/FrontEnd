      ...
      <DateTitle>2024. 6. 21 분석 결과</DateTitle>
        <SVGContent>
          <SVGImage src={ResultBox} width={312} height={169} alt="loading"/>
            <FirstLine><RedText>지방, 비타민 A가</RedText> 부족해요!</FirstLine>
            <SecondLine>몸무게 1.6kg | 활동량 보통</SecondLine>
          </SVGContent>
          <StyledLink href={`/${petId}/${dailyMealId}/추천영양성분`}>
            <RecommendationButton>추천 영양성분 보기</RecommendationButton>
          </StyledLink>
        <GraphContainer>
        <GraphText1><GreenText >20kcal</GreenText > 더 먹어도 좋아요!</GraphText1>
        <GraphText2><GreenText >김백순</GreenText >의 하루 권장 섭취량은 260kcal에요</GraphText2>
            {/*그래프 */}
        </GraphContainer>
        <StyledLink href={`/${petId}/${dailyMealId}/영양소상세`}>
          <DetailButton>영양소 상세 보기</DetailButton>
        </StyledLink>
        <MealListTitle><GreenText>김백순</GreenText>이 먹은 하루 식단</MealListTitle>
        <ContentContainer>
          {dailyMeals ? (
